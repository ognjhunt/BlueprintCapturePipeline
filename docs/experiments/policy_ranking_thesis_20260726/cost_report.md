...
The current evidence does not yet establish the thesis's speed or cost advantage. It establishes that label-blind preparation and hybrid-site ingestion can be performed locally without a paid GPU and records the completed v2 pilot's judge cost and completion-invocation wall time. The interrupted attempt's elapsed time was not finalized; the process was observed beyond 446 seconds and that lower-bound observation is preserved rather than converted into a false exact duration. A final verdict still needs WAM/policy runtime and a fair physical counterfactual, and must state whether any physical-exhaustive comparison is measured, sourced, or merely a range.
