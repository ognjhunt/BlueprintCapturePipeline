...
The experiment can proceed internally with the pinned components above under their stated restrictions. Any rollout-media redistribution, customer-facing media use, gated InteriorGS access, or physical-robot lane remains separately gated. User authorization covers bounded compute for this goal but does not cure missing third-party rights.
