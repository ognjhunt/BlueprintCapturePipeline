...
| Pipeline deployment-identity seam | PR #252's fail-closed `/api/live-pipeline/version` seam is live in production. It reports exact commit `3bb376e7b987a34ee3fa0dc5e39c9ab42e6c59f8`, `commit_proven=true`, and `deployed_service_identity_only`; the endpoint, clean checkout, `origin/main`, remote `main`, and Git tree agree. Rollback material was preserved under `/var/backups/blueprint/pipeline-control-plane-20260801T120657Z-pre-3bb376e7`; its protected environment and source-commit files have SHA-256 `b3ab24dd975c8bd793730163772053db9a7e400ddf4d7945d5f5c5c01b8b915a` and `a2b33590d841db3019628809743100b14916ecd3ec0fcbac32464fe4e36f2835`. Caddy validation, authenticated-route denial, control-plane health, and zero-spend fail-closed checks pass. This proves deployed service identity and rollback readiness only; it does not prove a real capture, physical success, deployment safety, or policy ranking. |
...
| Publication/deployment/parity | Integrated Pipeline, Capture, and WebApp slices published; Pipeline and WebApp production identity proven | Pipeline PRs through #275 and WebApp PRs through #434 are merged through protected main; Capture remote main is currently `c4e03f9dfc4d64e86aedc4a7c9905bfa7dd8e646`. Pipeline protected main and production are exact `3bb376e7b987a34ee3fa0dc5e39c9ab42e6c59f8`, tree `e949d075c4a01fca9d8954786c280286b5869a83`, divergence `0 0`, with a clean deployed checkout and a hash-bound rollback backup. WebApp main and Render production are exact `6e24b5e1dbba43e5f34f38221f353089525cb74d`. Public Pipeline identity, authenticated-route denial, Caddy configuration, control-plane health, and fail-closed spend state pass. Pub/Sub runtime packaging is fixed, but live subscription access is intentionally disabled pending explicit credential/IAM authorization. No isolated staging service, physical-device Capture proof, raw rights-cleared walkthrough, or full real-capture vertical slice has passed; production service identity must not be described as physical/deployment-readiness evidence. |
...
- Production Pipeline service identity was deployed to exact protected-main
  commit `3bb376e7b987a34ee3fa0dc5e39c9ab42e6c59f8` with a hash-bound rollback
