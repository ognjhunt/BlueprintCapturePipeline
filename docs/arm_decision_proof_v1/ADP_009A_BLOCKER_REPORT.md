...
- `interiorgs_appearance_scene`: publisher scene `840313`, target `ins160`
  (`canned_beverage`).
- `sage3d_collision_companion`: exact publisher-aligned companion, removable
...
The external prerequisite receipt
