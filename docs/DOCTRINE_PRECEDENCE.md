...
active. An agent must name the Arm Decision Proof item and gate a legacy document
directly unblocks before using it as implementation direction.
...
5. [`../VISION.md`](../VISION.md) — the bounded proof horizon and explicitly
   conditional future. It never overrides the two documents above.
...
1. The Arm Decision Proof north-star contract and implementation backlog.
2. The Practical Rule For Agents and product doctrine in
   [`../PLATFORM_CONTEXT.md`](../PLATFORM_CONTEXT.md).
3. The strategy and build priorities in
   [`../WORLD_MODEL_STRATEGY_CONTEXT.md`](../WORLD_MODEL_STRATEGY_CONTEXT.md).
4. [`../VISION.md`](../VISION.md) as bounded conditional direction.
5. Repo-level guides ([`../AGENTS.md`](../AGENTS.md), architecture docs) as
