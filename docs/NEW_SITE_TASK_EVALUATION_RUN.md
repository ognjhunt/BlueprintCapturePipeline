...
binding only from the matching digest-bound binding result. The placement stage
likewise recognizes `external_scene_robot_placement_candidate.v1`, but that
