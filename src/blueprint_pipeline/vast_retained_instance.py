...
def bind_all_in_cost(
    ...
    *,
    ...
    effective_max_hourly_rate = (
        max_hourly_rate if max_hourly_rate is not None else max_hourly_rate_usd
    )
    all_in_rate_under_max = all_in_rate_observed and (
        effective_max_hourly_rate is None
        or all_in_rate <= effective_max_hourly_rate
    )
    binding = {
        ...
        "all_in_hourly_rate_under_max": all_in_rate_under_max,
        ...
        "all_in_hourly_rate_under_max_hourly": all_in_rate_under_max,
        "raw_secret_values_recorded": False,
    }
