...
def _partial_policy_canary_result(
    *, native_path: Path, fallback: Mapping[str, Any], runtime_inputs: Mapping[str, Any],
    specs: Mapping[str, Mapping[str, Any]],
) -> tuple[dict[str, Any], Path] | None:
    """Preserve the dispatcher seam for sealed partial-cell recovery."""
    return _recover_partial_policy_canary_result(
        native_path=native_path, fallback=fallback, runtime_inputs=runtime_inputs, specs=specs,
        read_record=_read, sha256=_sha256, write_record=write_json,
