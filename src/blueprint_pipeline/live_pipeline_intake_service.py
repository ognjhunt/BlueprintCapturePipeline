...
def create_app() -> FastAPI:
    ...
    def health() -> Dict[str, Any]:
        ...
        return {
            ...
            # Compatibility projection for the deployment-parity verifier and
            # older operators. This is configuration presence only; it does
            # not reveal a credential or prove an authenticated request.
