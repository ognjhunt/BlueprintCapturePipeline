...
def measure_gripper_convention_and_newton_drive(
    *, env: Any, action: Any, robot: Any, torch: Any, to_torch: Any, backend: str
    ...
    # Isaac Lab exposes articulation body names through ``ArticulationData``.
    # Reading them from the articulation itself works in lightweight fakes but
    # fails in the pinned native runtime before the first probe step.
