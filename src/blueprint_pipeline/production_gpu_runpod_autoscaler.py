...
class RunPodAutoscalerAuthorization:
    ...
    combined_gpu_wall_time_cap_seconds: int = 18_000
    spent_usd: float = 0.0
    ...
    def blockers(self) -> list[str]:
        ...
        if not 0 < int(self.combined_gpu_wall_time_cap_seconds) <= 18_000:
            blockers.append("gpu_wall_time_cap_exceeds_authorized_18000_seconds")
