...
BACKEND_ISAAC_USD_GEOMETRY = "isaac_usd_geometry"
DEVELOPMENT_BACKEND_KINDS = frozenset({BACKEND_PARTICLEFIELD_BLUEPRINT_PRIVATE, BACKEND_ISAAC_USD_GEOMETRY})
...
BACKEND_LAUNCH_RENDER_PATHS: dict[str, str] = {
    BACKEND_ISAAC_USD_GEOMETRY: "usd_geometry",
