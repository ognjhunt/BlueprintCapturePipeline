...
from .task_evaluation_configured_controls_autostart_validation import (
    INTENT_SCHEMA_VERSION as INTENT_SCHEMA_VERSION,
    RESULT_SCHEMA_VERSION as RESULT_SCHEMA_VERSION,
    DEFAULT_MAX_PLACEMENT_INFERENCE_COST_USD as DEFAULT_MAX_PLACEMENT_INFERENCE_COST_USD,
    _COMMIT as _COMMIT,
    _DIGEST as _DIGEST,
    _FIXED_PATHS as _FIXED_PATHS,
    _artifact as _artifact,
    _intent_paths as _intent_paths,
    validate_configured_controls_autostart_intent as validate_configured_controls_autostart_intent,
    _validate_result as _validate_result,
)
...
from . import task_evaluation_configured_controls_deferred_inputs as deferred_inputs
    ...
    *,
    ...
    try:
        paths = deferred_inputs.resolve_deferred_inputs(
            intent=intent, revision=revision, output_root=root
        )
