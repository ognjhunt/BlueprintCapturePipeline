...
def _author_flattened_cousin(
    *,
    ...
    # USD flatten otherwise writes the composed root layer's absolute path
    # into the output documentation.  That makes the digest a property of the
    # checkout directory instead of the sealed inputs.
