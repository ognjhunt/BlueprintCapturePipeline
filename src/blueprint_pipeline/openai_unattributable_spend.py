"""Record a non-terminal billing gap when OpenAI cost cannot be attributed.
...
The only honest record is to reserve the full authority cap against the next
authority, name the structural cause, and refuse to present the result as a
final cost or family closure.  This module never estimates, never accepts a
candidate-reported figure, and never sets ``cost_is_final``.
"""
...
def materialize_openai_unattributable_spend(
    *,
    ...
    receipt: dict[str, Any] = {
        ...
        "terminal_billing_evidence": False,
        "billing_gap": "official_openai_cost_attribution_unavailable",
