...
_PROMPT = (
    ...
    "Compare every non-target object's complete silhouette, height, opacity and shape "
    "against the source anchor. A partially missing or newly translucent neighboring "
    "object must set preserves_non_target_content false, even when the target is absent. "
    "Do not infer visual preservation from frozen geometry or other pipeline claims. "
