"""Independent RunPod storage-volume deadline watchdog and teardown helpers.

This module can inventory and delete retained RunPod resources after an
allocation deadline. It cannot create a Pod or volume and is launched only by
the canonical storage-only model-volume allocator.
"""
