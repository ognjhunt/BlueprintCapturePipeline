...
def test_committed_protocol_and_snapshot_manifest_digests_are_frozen() -> None:
    ...
    checks = (
        ...
        ("protocol_amendment_v9.json", "amendment_sha256"),
        ("allocation_6_oscar_replay_failure_v1.json", "result_sha256"),
        ("oscar_public_replay_bundle_receipt_v2.json", "receipt_sha256"),
        ...
        ("oscar_replay_canary_bundle_freeze_v1.json", "freeze_sha256"),
    ...
    assert payloads["oscar_replay_canary_bundle_freeze_v1.json"]["runtime"]["fps"] == 14.0
