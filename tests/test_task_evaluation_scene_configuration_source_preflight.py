...
def _bind_source_evidence(envelope_path: Path, *, exact_target_prim: str) -> dict:
    ...
    expected = {
        "aabb_min_xyz_m": [1.0, 2.0, 3.0],
        "aabb_max_xyz_m": [2.0, 3.0, 4.0],
        "point_count": 12,
        "face_count": 20,
    }
    source_object = {
    ...
    for index, path in ((0, stage_one_path), (1, stage_two_path)):
    ...
    return {"envelope": envelope, "configurations": {"stage-1": stage_one, "stage-2": stage_two}}
