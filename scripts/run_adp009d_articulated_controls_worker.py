...
try:  # flat provider-bundle layout
    from articulated_control_verdict import (
        downsample_trace as _downsample,
        evaluate_positive_control as _evaluate_positive,
        seal_detent_torque as _seal_torque,
    )
except ModuleNotFoundError:  # repository checkout
    import sys as _sys

    _sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "src"))
    from blueprint_pipeline.articulated_control_verdict import (
        downsample_trace as _downsample,
        evaluate_positive_control as _evaluate_positive,
        seal_detent_torque as _seal_torque,
    )
