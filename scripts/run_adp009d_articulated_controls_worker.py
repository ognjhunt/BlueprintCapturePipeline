...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        result["readbacks"]["forced_positive_reaches_success_window"] = {
            "angle_at_release_degrees": positive["angle_at_release_degrees"],
            "window": window,
            "passed": window[0] <= positive["angle_at_release_degrees"] <= window[1],
        }
        result["readbacks"]["forced_positive_holds_after_release"] = {
            "drift_after_release_degrees": positive["drift_after_release_degrees"],
            "settled_angle_degrees": positive["settled_angle_degrees"],
            "passed": positive["inside_success_window"],
        }
